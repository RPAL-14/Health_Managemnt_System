...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    if (isset($_POST['uid']) && isset($_POST['name']) && isset($_POST['contact_no']) && isset($_POST['address']) && isset($_POST['other'])) {
                ...
                <div class="row g-3">
                    <div>
                        <div class="col-12">
                            ...
                            <input type="number" class="form-control" style="width: 100%;" id="Name" placeholder="Enter your Adhaar Card number" name="uid" value="" required="" maxlength="12" oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);">
                        </div>
                    </div>
                    ...
                    <center>
                        <button id="getHelpButton" type="submit" class="btn btn-success">Get Help</button>
                    </center>
                </div>
            </form>
            <center>
                <br>
                <a href="./H_Home.php"><button type="button" id="getHelpButton" class="btn btn-success">Go Back</button></a>
            </center>
        </div>
        <footer class="pt-3 text-body-secondary text-center text-small">
            <center>
                <p class="mb-1" style="color: white;">© SBP</p>
            </center>
        </footer>
    </div>
</body>
