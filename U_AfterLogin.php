				...
				<div class="row row-cols-1 row-cols-lg-2 align-items-stretch" style="margin-bottom: 30px;">
					...
					<div class="col" style="margin-bottom: 20px;">
						<a href="./S_BD.php" style="text-decoration: none;">
							<div class="card card-cover h-100 overflow-hidden text-bg-dark rounded-4 shadow-lg position-relative" style="background-image: url('images/Blood\ Donation.jpeg'); background-size: cover; background-color: rgba(0, 0, 0, 0.5); /* Black color with 50% opacity */">
					...
					<div class="col" style="margin-bottom: 20px;">
						<a href="./S_NH.php" style="text-decoration: none;">
							<div class="card card-cover h-100 overflow-hidden text-bg-dark rounded-4 shadow-lg position-relative" style="background-image: url('images/hospital\ bed.jpeg'); background-size: cover; background-color: rgba(0, 0, 0, 0.5); /* Black color with 50% opacity */">
								<div class="d-flex flex-column h-100 p-5 text-white text-shadow-1">
					...
					<div class="col" style="margin-bottom: 20px;">
						<a href="./S_IR.php" style="text-decoration: none;">
							<div class="card card-cover h-100 overflow-hidden text-bg-dark rounded-4 shadow-lg position-relative" style="background-image: url('images/Investigation\ Report.png'); background-size: cover; background-color: rgba(0, 0, 0, 0.5); /* Black color with 50% opacity */">
								<div class="d-flex flex-column h-100 p-5 text-white text-shadow-1">
					...
					<!-- Service 4 -->
					<div class="col" style="margin-bottom: 20px;">
						<a href="./U_GMC.php" style="text-decoration: none;">
							<div class="card card-cover h-100 overflow-hidden text-bg-dark rounded-4 shadow-lg position-relative" style="background-image: url('./images/medicalcertificate.png'); background-size: cover; background-color: rgba(0, 0, 0, 0.5); /* Black color with 50% opacity */">
								<div class="d-flex flex-column h-100 p-5 text-white text-shadow-1">
									<h3 class="pt-5 mt-5 mb-4 display-6 lh-1 fw-bold">Get Medical Certificate</h3>

									<div class="description">
										<p>This functionality is used to generate the medical certificate as per the records of
											The Government of Republic of India that can used domestically as well as internationally.
											This gives the reader and the beneficiary a brief idea of the status of the patient.
										</p>
									</div>
								</div>
							</div>
	...
	<div style="background-color: grey; color:white;">
		<footer class="row row-cols-1 row-cols-sm-2 row-cols-md-5 pt-5 border-top">
			<div class="col mb-3" style="margin-top: 20px;">
				<center><svg xmlns="http://www.w3.org/2000/svg" width="70" height="40" fill="currentColor" class="bi-heart-pulse" viewBox="0 0 16 16" style="color:white; margin-bottom:0px;">
						<path d="m8 2.748-.717-.737C5.6.281 2.514.878 1.4 3.053.918 3.995.78 5.323 1.508 7H.43c-2.128-5.697 4.165-8.83 7.394-5.857q.09.083.176.171a3 3 0 0 1 .176-.17c3.23-2.974 9.522.159 7.394 5.856h-1.078c.728-1.677.59-3.005.108-3.947C13.486.878 10.4.28 8.717 2.01zM2.212 10h1.315C4.593 11.183 6.05 12.458 8 13.795c1.949-1.337 3.407-2.612 4.473-3.795h1.315c-1.265 1.566-3.14 3.25-5.788 5-2.648-1.75-4.523-3.434-5.788-5" />
						<path d="M10.464 3.314a.5.5 0 0 0-.945.049L7.921 8.956 6.464 5.314a.5.5 0 0 0-.88-.091L3.732 8H.5a.5.5 0 0 0 0 1H4a.5.5 0 0 0 .416-.223l1.473-2.209 1.647 4.118a.5.5 0 0 0 .945-.049l1.598-5.593 1.457 3.642A.5.5 0 0 0 12 9h3.5a.5.5 0 0 0 0-1h-3.162z" />
					</svg>
					<h2>Swasth Bharat Pranali</h>
				</center>
			</div>
			...
			<div class="col mb-3">
				<ul class="nav flex-column" style="margin-left: 70px; margin-top:20px;">
					<li class="nav-item mb-2"><a href="./U_SOS.php" class="nav-link p-0 text-body-secondary">SOS</a></li>
					<li class="nav-item mb-2"><a href="./U_AboutUs.php" class="nav-link p-0 text-body-secondary">About Us</a></li>
					<li class="nav-item mb-2"><a href="./U_ContactUs.php" class="nav-link p-0 text-body-secondary">Contact Us</a></li>
					<li class="nav-item mb-2"><a href="./S_FS.php" class="nav-link p-0 text-body-secondary">Our financial aid scheme</a></li>
				</ul>
			</div>
