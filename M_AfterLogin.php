...
<body>
        ...
        <div class="container-fluid" style="background-color: #2D9596; ">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    <li class="nav-item">
                        <a class="nav-link active" aria-current="page" href="./M_AboutUs.php" style="color: white;">About us</a>
                    </li>
                ...
                <div style="margin-right: 25px;">
                    <a href="./M_HealthInfo.php"><button type="button" class="btn btn-success">Check
                            Records</button></a>
                </div>

                <div class="nav-item dropdown" style="margin-right: 20px;">
					<a class="nav-link" href="#" id="user-name" style="color: white;"><?php
																						$tempHID = $_SESSION["hid"];
																						echo "Hospital ID: $tempHID";
																						?></a>
				</div>

                <div style="margin-right: 25px;">
                    <a href="./e_logout.php"><button type="button" class="btn btn-success" style="background-color:#b30000">Logout</button></a>
                </div>
    ...
    <body>
            ...
            <div id="carouselExampleCaptions" class="carousel slide" style="padding-top: 60px;">
                ...
                <div class="carousel-inner">
                    <div class="carousel-item active">
                        ...
                        <div class="carousel-caption d-none d-md-block text-start" style="margin-left: 0;margin-bottom: 60px;">
                    ...
                    <div class="carousel-item">
                        <div class="image-container">
                            <img src="./images/Patient1.png" class="d-block w-100" alt="Doctor">
                        </div>
                        <div class="carousel-caption d-none d-md-block text-start" style="margin-bottom: 150px;">
                            <h1 style="text-align: start;align-items: center;">View Health records here:</h1><br>
                            <button type="button" class="btn btn-success">
                                <a href="./M_HealthInfo.php" style="color: white; text-decoration: none;">Check Health
                                    records</a>
                            </button>
                        </div>
                    </div>
        ...
        <script src="https://cdn.jsdelivr.net/npm/bootstrap@5.3.0-alpha1/dist/js/bootstrap.bundle.min.js" integrity="sha384-NvA7W8cU2t4z/VHDzX4qmaWCy5vr/gDZxU+Gq3QgQtCfcd+2cR9FX+8xFnRE6I1k" crossorigin="anonymous"></script>
    ...
    <div class="article-section" style="background: url(images/Blood\ Donation.jpeg); margin-bottom: 50px;border-radius: 0; margin-top: 0px;">
        <div class="animation-container" style="color: white;">
            <h2>Read Our Articles to Learn More</h2>
            <!-- Animation goes here -->
        </div>
        <a href="./M_Article.php" class="article-link" style="text-decoration: none; color: black;">
    ...
    <div style="background-color: grey; color:white;">
        <footer class="row row-cols-1 row-cols-sm-2 row-cols-md-5 pt-5 border-top">
          ...
          <path
            ...
            <div class="col mb-3">
                <h5>Check Health Records</h5>
                <ul class="nav flex-column" style="margin-left: 10px;">
                    <li class="nav-item mb-2"><a href="./M_Healthinfo.php" class="nav-link p-0 text-body-secondary">Check Prescription</a></li>
                    <li class="nav-item mb-2"><a href="./M_Healthinfo.php" class="nav-link p-0 text-body-secondary">Medical History</a></li>
                    <li class="nav-item mb-2"><a href="./M_Healthinfo.php" class="nav-link p-0 text-body-secondary">Vaccination Record</a></li>
                    <li class="nav-item mb-2"><a href="./M_Healthinfo.php" class="nav-link p-0 text-body-secondary">Investigation Report</a></li>
                </ul>
            </div>
