...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    if (isset($_POST['buid']) && isset($_POST['name']) && isset($_POST['mobile']) && isset($_POST['email']) && isset($_POST['message'])) {
...
<body>
    <div class="container">
        ...
        <form method="post" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>">
            <label for="">Benificiary Unique ID:</label>
            <input type="number" id="number" name="buid" required="" maxlength="12" oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);">
        ...
        <center>
            <a href="./H_Home.php"><input type="submit" value="Go Back"></a>
        </center>
